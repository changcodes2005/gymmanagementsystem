...
public class UpdateDeleteMember extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        // when the close button is clicked, everything is not shown. It is false
        setVisible(false);
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        // makes it gone and then makes the new page come out
        setVisible(false);
        new UpdateDeleteMember().setVisible(true);
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        ...
        String idnumber=jTextField9.getText();
        String age=jTextField10.getText();
        String others=jTextField11.getText();
        try 
        {
            Connection con=ConnectionProvider.getCon();
            PreparedStatement ps=con.prepareStatement("update member  set name=?,mobilenumber=?,email=?,fathername=?,mothername=?,idnumber=?,age=?,others=? where id=?");
            ps.setString(1, name);
